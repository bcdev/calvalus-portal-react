...
import {ExternalObjectComponentProps, ExternalObjectComponent} from './ExternalObjectComponent';
...
interface MyExternalComponentProps extends ExternalObjectComponentProps<MyExternalObject, MyExternalState>, MyExternalState {
}
